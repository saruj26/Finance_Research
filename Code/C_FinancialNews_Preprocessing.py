# ========================================================
# Preprocessing Financial News Dataset for FinBERT & Topic Modeling
# ========================================================
...
# Define main project directory relative to this script
PROJECT_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
DATA_DIR = os.path.join(PROJECT_PATH, "Data")

INPUT_DATASET_PATH = os.path.join(DATA_DIR, "collected_data", "financial_News.csv")
OUTPUT_DIR_PATH = os.path.join(DATA_DIR, "preprocessed_data")
